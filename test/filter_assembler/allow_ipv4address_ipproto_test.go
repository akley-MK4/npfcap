...
func TestAllowSingleSrcIPV4AddressIPProto(t *testing.T) {
...
func TestAllowSingleSrcIPV4AddressMultipleIPProto(t *testing.T) {
	cond := assembler.Condition{
		Reject: false,
		SrcIPV4List: []net.IP{
			net.ParseIP("1.1.1.1"),
...
func TestAllowMultipleSrcIPV4AddressIPProto(t *testing.T) {
	cond := assembler.Condition{
		Reject: false,
		SrcIPV4List: []net.IP{
			net.ParseIP("1.1.1.1"),
...
func TestAllowSingleDstIPV4AddressIPProto(t *testing.T) {
	cond := assembler.Condition{
		Reject: false,
		DstIPV4List: []net.IP{
			net.ParseIP("1.1.1.1"),
...
func TestAllowSingleDstIPV4AddressMultipleIPProto(t *testing.T) {
	cond := assembler.Condition{
		Reject: false,
		DstIPV4List: []net.IP{
			net.ParseIP("1.1.1.1"),
...
func TestAllowMultipleDstIPV4AddressIPProto(t *testing.T) {
	cond := assembler.Condition{
		Reject: false,
		DstIPV4List: []net.IP{
			net.ParseIP("1.1.1.1"),
...
func TestAllowSingleSrcDstIPV4AddressIPProto(t *testing.T) {
	cond := assembler.Condition{
		Reject: false,
		SrcIPV4List: []net.IP{
			net.ParseIP("1.1.1.1"),
...
func TestAllowMultipleSrcIPV4AddrSingleDstIPV4AddrIPProto(t *testing.T) {
	cond := assembler.Condition{
		Reject: false,
		SrcIPV4List: []net.IP{
			net.ParseIP("1.1.1.1"),
...
func TestAllowMultipleDstIPV4AddrSingleSrcIPV4AddrIPProto(t *testing.T) {
	cond := assembler.Condition{
		Reject: false,
		SrcIPV4List: []net.IP{
			net.ParseIP("1.1.1.1"),
...
func TestAllowSingleSrcDstIPV4AddrMultipleIPProto(t *testing.T) {
	cond := assembler.Condition{
		Reject: false,
		SrcIPV4List: []net.IP{
			net.ParseIP("1.1.1.1"),
...
func TestAllowMultipleSrcDstIPV4AddrIPProto(t *testing.T) {
	cond := assembler.Condition{
		Reject: false,
		SrcIPV4List: []net.IP{
			net.ParseIP("1.1.1.1"),
